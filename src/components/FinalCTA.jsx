    ...
    <section id="contact" className="py-24 relative overflow-hidden bg-[#060c08] border-t border-white/5 cyber-grid-bg">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto glass-panel p-8 sm:p-14 text-center border-lime-500/40 shadow-2xl shadow-lime-950/60 relative">
          ...
          <div className="text-base sm:text-lg text-slate-300 max-w-2xl mx-auto mb-8 font-light leading-relaxed space-y-4">
            <p>
              From luxury smart villas and corporate offices to healthcare facilities and large-scale industrial sites, ESS delivers intelligent, scalable technology solutions tailored to the unique needs of every space.
            </p>
            <p>
              Smart automation, advanced security, and reliable connectivity — thoughtfully integrated around you.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 pt-8 border-t border-white/10 font-mono text-xs text-slate-300">
            <a 
            ...
            <a
              ...
              className="p-3 rounded-xl bg-white/[0.03] border border-white/5 hover:border-lime-500/30 flex items-center justify-center gap-2 transition-colors sm:col-span-2 lg:col-span-1"
            >
