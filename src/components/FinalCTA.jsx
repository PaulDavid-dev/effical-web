...
export default function FinalCTA({ onOpenPlanner }) {
  return (
    <section id="contact" className="py-24 relative overflow-hidden bg-[#070b12] border-t border-white/5 cyber-grid-bg">
      ...
      <div className="container-custom relative z-10">
        <div className="max-w-4xl mx-auto glass-panel p-8 sm:p-14 text-center border-cyan-500/40 shadow-2xl shadow-cyan-950/60 relative">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4">
            ...
            <span className="text-gradient-cyan">Your Complete Control.</span>
          </h2>
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 mb-10">
            <button
              ...
              className="btn-primary text-base py-4 px-8 shadow-cyan-500/30"
            >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-8 border-t border-white/10 font-mono text-xs text-slate-300">
            <a 
              ...
              className="p-3 rounded-xl bg-white/[0.03] border border-white/5 hover:border-cyan-500/30 flex items-center justify-center gap-2 transition-colors"
            >
