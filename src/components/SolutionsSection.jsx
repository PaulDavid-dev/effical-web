...
export default function SolutionsSection({ onOpenPlanner }) {
  ...
  return (
    <section id="solutions" className="py-24 relative overflow-hidden bg-[#06090e] z-10">
      ...
      <div className="container-custom relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-white tracking-tight mb-4 font-syne">
            ...
            <span className="text-gradient-animated-amber">Beautifully Connected.</span>
          </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          {SOLUTIONS_DATA.map((solution) => {
            ...
            return (
              <div 
                key={solution.id} 
                className="glass-card group flex flex-col justify-between border-white/10 hover:border-amber-500/40 p-6 sm:p-8"
              >
                <div>
                  {/* Card Header & Image */}
                  <div className="relative h-52 rounded-2xl overflow-hidden mb-6">
                    ...
                    <div className="absolute top-4 left-4 flex items-center gap-2">
                      <div className="w-10 h-10 rounded-xl bg-[#06090e]/80 backdrop-blur-md border border-amber-500/30 flex items-center justify-center text-amber-400 shadow-lg">
                        <Icon className="w-5 h-5" />
                      </div>
                      <span className="px-3 py-1 rounded-full bg-black/60 backdrop-blur-md border border-white/15 text-xs font-mono text-amber-300 font-semibold">
                        {solution.tag}
                      </span>
                    </div>
                  </div>
                  ...
                  <h3 className="text-2xl font-bold text-white mb-2 group-hover:text-amber-400 transition-colors font-syne">
                    {solution.title}
                  </h3>
                ...
                <div className="pt-4 border-t border-white/10 flex items-center justify-between gap-3">
                  <button
                    ...
                    className="text-xs font-mono font-semibold text-amber-400 hover:text-amber-300 flex items-center gap-1.5 transition-colors py-2 cursor-pointer"
                  >
      ...
      {selectedSolution && (
        <div className="modal-overlay" onClick={() => setSelectedSolution(null)}>
          <div 
            className="glass-panel max-w-2xl w-full p-6 sm:p-8 relative max-h-[90vh] overflow-y-auto border-amber-500/40"
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <span className="text-xs font-mono text-emerald-400">TURNKEY ARCHITECTURE</span>
            </div>
