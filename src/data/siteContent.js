...
export const BRANDS = {
  ess: {
    ...
    email: "Sales@efficalsmartsolutions.com",
    supportEmail: "Sales@efficalsmartsolutions.com",
    location: "Coimbatore",
...
export const INDUSTRIES_DATA = [
  {
    ...
    badge: "Smart Homes",
    description: "End-to-end smart home automation, security, and networking solutions for luxury villas, penthouses, and gated communities — seamlessly integrated for effortless control, enhanced security, and connected living.",
  ...
  },
  {
    ...
    description: "Advanced access control, CCTV surveillance, video intercoms, and high-performance networking designed for hospitals and medical facilities — helping secure restricted areas, monitor critical zones, manage staff access, and maintain reliable connectivity across the facility.",
  ...
  },
  {
    ...
    description: "Integrated security, access control, and networking solutions for factories, warehouses, and industrial facilities — including perimeter surveillance, RFID-enabled boom barriers, vehicle access management, and reliable network infrastructure for critical operations.",
